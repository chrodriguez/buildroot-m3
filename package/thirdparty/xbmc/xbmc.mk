...
ifneq ($(strip $(BR2_XBMC_SPLASH_SCREEN)),"")
  XBMC_SPLASH_SCREEN = $(BR2_XBMC_SPLASH_SCREEN)
  
define XBMC_INSTALL_SPLASH
  cp -f $(XBMC_SPLASH_SCREEN) $(TARGET_DIR)/usr/share/xbmc/media/Splash.png
endef
  
endif # BR2_XBMC_SPLASH_SCREEN
